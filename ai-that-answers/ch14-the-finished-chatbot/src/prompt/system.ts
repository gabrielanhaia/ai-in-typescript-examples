// Byte-stable: no date, no request ID, no interpolated customer name. Whatever
// goes in here has to be the same bytes next turn, or the prefix cache is
// unusable and nothing tells you so.
